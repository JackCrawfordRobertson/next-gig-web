...
const SECTION_ARROWS = [
  {
    ...
    color: "#1e90ff",
    position: "right-0 top-[80vh] md:top-[60vh] w-[200px] md:w-[300px] transform rotate-[-100deg]",
  ...
  },
  {
    ...
    color: "#1e90ff",
    position: "left-0 top-[145vh] md:top-[140vh] w-[250px] md:w-[350px] transform rotate-[160deg]",
  ...
  },
  {
    ...
    color: "#1e90ff",
    position: "right-0 top-[225vh] md:top-[200vh] w-[200px] md:w-[300px] transform rotate-[-170deg]",
  ...
  },
  {
    ...
    color: "#1e90ff",
    position: "left-0 top-[225vh] md:top-[200vh] w-[200px] md:w-[300px] transform rotate-[-170deg]",
    viewBox: "0 0 300 450"
  }
];
